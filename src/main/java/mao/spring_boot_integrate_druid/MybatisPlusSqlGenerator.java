package mao.spring_boot_integrate_druid;
 ...
 * Package(包名): mao.spring_boot_integrate_druid
 * Class(类名): MybatisPlus
 * Author(作者）: mao
...
public class MybatisPlusSqlGenerator
{
    public static void main(String[] args) throws IOException
    {
        ...
        FastAutoGenerator.create(properties.getProperty("jdbc.url"),
                ...
                {
                    builder.parent("mao.spring_boot_integrate_druid") // 设置父包名
